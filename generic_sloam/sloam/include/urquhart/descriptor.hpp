...
// Samples points around the perimeter of a polygon and returns a new set of
// points. The size of the returned PointVector depends on step. Smaller steps
// means more points will be sampled, e.g. step=0.05 means a point every 5% of
// the perimeter, resulting in 20 points.
