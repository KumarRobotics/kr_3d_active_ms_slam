...
class Segmentator(nn.Module):
    def __init__(self, ARCH, nclasses, path=None, path_append="", strict=False):
        ...
        # get the model
        bboneModule = imp.load_source("bboneModule", "./backbone/"+self.ARCH["backbone"]["name"]+".py")
        ...
        decoderModule = imp.load_source("decoderModule", "./decoder/"+self.ARCH["backbone"]["name"]+".py")
